					...
					output: {
						postReceive: [
							...
							},
							{
								type: 'set',
								properties: {
									value: '={{ (() => { console.log("[Resource Create] ========== RESPONSE IN POSTRECEIVE =========="); console.log("[Resource Create] Full Response Data:", JSON.stringify($json, null, 2)); console.log("[Resource Create] Response Type:", typeof $json); if ($json && typeof $json === "object") { console.log("[Resource Create] Response Keys:", Object.keys($json)); if ($json.id) { console.log("[Resource Create] Resource ID:", $json.id); } } console.log("[Resource Create] ========================================"); const result = { ...$json, resource_id: $json.id }; return result; })() }}',
								},
							},
						],
					},
